...
def getCardNum():
    ...
    dll.Read_Guest_Card.argtypes = [ctypes.c_int,ctypes.c_char_p,ctypes.c_char_p,ctypes.c_char_p,ctypes.c_char_p,ctypes.c_char_p,ctypes.c_char_p,ctypes.c_char_p,ctypes.c_char_p,ctypes.c_char_p,ctypes.c_char_p]
    dll.Read_Guest_Card.restypes = ctypes.c_int

    result=dll.Read_Guest_Card(bPort, strID, strPWD, iCardNo, iGuestSN, iGuestIdx, strDoorID, strSuitDoor, strPubDoor, strBeginTime, strEndTime)
    if result == 0:
